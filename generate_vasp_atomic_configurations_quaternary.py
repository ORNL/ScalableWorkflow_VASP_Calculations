...
def generate_VASP_randomized_ternary_configurations(source_path, destination_path, atomic_increment, symmetry_savings,
    ...
    assert 4 == len(elements_list), "This function can only be used for quaternary alloys"
...
if __name__ == '__main__':
    ...
    source_path = current_directory + '/template_BCC_Nb-Ta-V-Zr'
    destination_path = current_directory + '/bcc/Nb-Ta-V-Zr'
    atomic_increment = 8
